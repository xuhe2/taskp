...
const (
	TaskService_CommitTask_FullMethodName = "/main.TaskService/CommitTask"
	TaskService_GetTask_FullMethodName    = "/main.TaskService/GetTask"
)
...
func _TaskService_CommitTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(TaskServiceServer).CommitTask(ctx, in)
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TaskService_CommitTask_Handler,
		},
		{
			MethodName: "GetTask",
